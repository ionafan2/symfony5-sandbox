 ...
 */
final class Version20220718000903 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE answer CHANGE status status VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE answer CHANGE status status VARCHAR(15) NOT NULL');
    }
}
